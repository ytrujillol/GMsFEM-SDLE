...
% Dfp
D12(I) = u0(I+1) - u0(I);
D12(1) =D12(2);% u0(2) - u0(1);
D12(N) =D12(N-1);% u0(1) - u0(N);
        
%Dfm
D_12(I) = u0(I) - u0(I-1);
D_12(1) =D_12(2);% u0(1) - u0(N);
D_12(N) =D_12(N-1);% u0(N) - u0(N-1);
...
%       Derivada centrada
       D_2(I) = u0(I+1) - u0(I-1);
       D_2(1) =D_2(2);% u0(2) - u0(N);
       D_2(N) =D_2(N-1);% u0(1) - u0(N-1);
    ...
    case 3
        ...
        D_2j(1) =D_2j(1);% u0(N)-2*u0(1)+u0(2);
